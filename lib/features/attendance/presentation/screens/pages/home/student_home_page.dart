...
// Import the real scan page (lives in assignments/presentation/)
...
class _StudentHomePageState extends State<StudentHomePage>
  ...
  void initState() {
    ...
    _pages = [
      ...
      // Real scan page: QR scanner → local_auth biometrics → MLKit face detection → sign + submit
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GNav(
        ...
        activeColor: Colors.white, tabBackgroundColor: _green,
...
class _HomeBody extends StatelessWidget {
  ...
  const _HomeBody({required this.fadeCtrl, required this.slideCtrl,
          ...
          flexibleSpace: FlexibleSpaceBar(
            background: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(colors: [_green, _greenMid, Color(0xFF66BB6A)],
                  ...
                  child: Padding(
                    ...
                    child: Row(children: [
                      CircleAvatar(radius: 28, backgroundColor: Colors.white.withOpacity(0.2),
                        child: Text(firstName.isNotEmpty ? firstName[0].toUpperCase() : 'S',

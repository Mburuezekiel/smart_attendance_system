...
class _AdminHomePageState extends State<AdminHomePage>
  ...
  Future<void> _loadData() async {
    ...
    final results = await Future.wait([
      ApiService().getUser(),
      ApiService().get('/users/dashboard-stats'),
    ]);
    ...
    // results[1] is ApiResult<Map<String,dynamic>>
...
class _ManageUsersPageState extends State<_ManageUsersPage> {
  ...
  Future<void> _fetchUsers({ int page = 1, bool append = false }) async {
    ...
    final result = await ApiService().get('/users', queryParams: query);
  ...
  @override Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? _teal : const Color(0xFFF0F0F0),
          borderRadius: BorderRadius.circular(20),
        ),
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: Text(initials, style: TextStyle(
              fontSize: 14, fontWeight: FontWeight.w800, color: _roleColor)),
        ),
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
              color: _roleColor.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(_roleIcon, size: 11, color: _roleColor),
            const SizedBox(width: 4),
            Text(roleLabel, style: TextStyle(
                fontSize: 10, fontWeight: FontWeight.w800, color: _roleColor)),
          ]),
        ),
      ),
    );
